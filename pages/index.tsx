            ...
            <Link href='/'>
              <a>
                <div className="divImg">
                  <Image alt="Logo" src='/download.jpg'  blurDataURL="blur" lazyRoot={lazyRoot} height={400} width={800} className='hoverScale right-0 bg-gray-500 w-full block' />
                </div>
              </a>
            </Link>
          </div>
        ...
        <div ref={rowRef1} className="grid sm:grid-cols-1 md:grid-cols-12 gap-x-12 items-center ">
          <div className="md:col-span-8 sm:col-span-12 relative" >
            <Link href='/'>
              <a>
                <div className="divImg">
                  <Image alt="Logo" src='/download.jpg'  blurDataURL="blur" lazyRoot={lazyRoot} height={400} width={800} className='hoverScale right-0 bg-gray-500 z-30 w-full block' />
                </div>
              </a>
            </Link>
          </div>
          ...
          <div className="container mx-auto md:mt-0 sx:mt-20">
            <div className="grid gap-6 md:grid-cols-3 sx:grid-cols-1  relative">
              <div className='colSectionBlog '>
                <Image alt='alt' className='imgSectionBlog'  blurDataURL="blur" lazyRoot={lazyRoot} src={'/blog.webp'} width={500} height={500} />
