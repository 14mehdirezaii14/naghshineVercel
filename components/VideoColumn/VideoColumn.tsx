...
const VideoColumn = ({ img }: any) => {
    ...
    return (
        <>
            <div onClick={() => setShowModal(true)} className=" md:col-span-8 z-50   md:order-2 sx:order-1  shadow-md shadow-black overflow-hidden sm:col-span-12 relative cursor-pointer">
            ...
            {showModal ? (
                <>
                    <div
                        className="justify-center  items-center w-100 h-100 flex bg-white overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
                    >
                        <button
