...
const VideoColumn = ({ img }: any) => {
    ...
    return (
        <>
            <div onClick={() => setShowModal(true)} className=" md:col-span-8 z-20 md:order-2 sx:order-1  shadow-md shadow-black overflow-hidden sm:col-span-12 relative cursor-pointer">
