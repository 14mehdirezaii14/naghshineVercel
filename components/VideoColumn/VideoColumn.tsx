...
const VideoColumn = ({ img }: any) => {
    ...
    return (
        <>
            <div onClick={() => setShowModal(true)} className=" md:col-span-8 my-box-shadow     md:order-2 sx:order-1  shadow-md overflow-hidden sm:col-span-12 relative cursor-pointer">
